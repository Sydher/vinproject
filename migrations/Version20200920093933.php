 ...
 */
final class Version20200920093933 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE wine (id INT AUTO_INCREMENT NOT NULL, region_id INT DEFAULT NULL, appellation_id INT DEFAULT NULL, productor_id INT NOT NULL, name VARCHAR(255) NOT NULL, color VARCHAR(255) NOT NULL, year VARCHAR(255) NOT NULL, format VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, vintage VARCHAR(255) DEFAULT NULL, price NUMERIC(5, 2) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_560C64685E237E06 (name), INDEX IDX_560C646898260155 (region_id), INDEX IDX_560C64687CDE30DD (appellation_id), INDEX IDX_560C646855BB310E (productor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
